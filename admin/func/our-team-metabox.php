...
<div id="team_dynamic_form">
	...
	<?php if ( isset( $employee_data['employee_image'] ) ): ?>
		<?php for( $i = 0; $i < count( $employee_data['employee_image'] ); $i++ ): ?>
		<div class="field_row">
			<div class="team_field_left">
				<div class="form_field">
					<label><?php _e('Employee\'s photo', 'fractal'); ?></label>
					<input type="text"
				...
				<div class="form_field">
					<label><?php _e('Employee\'s Name', 'fractal'); ?></label>
					<input type="text"
				...
				<div class="form_field">
					<label><?php _e('Employee\'s Position', 'fractal'); ?></label>
					<input type="text"
				...
				<div class="form_field">
					<label><?php _e('About Employee', 'fractal'); ?></label>
			...
			<div class="team_field_right">
				<input class="button" type="button" value="<?php _e('Choose File', 'fractal'); ?>" onclick="add_employee_image(this)" /><br />
				<input class="button" type="button" value="<?php _e('Remove', 'fractal'); ?>" onclick="remove_employee_field(this)" />
			</div>
	...
	<div style="display:none" id="employee-row">
		<div class="field_row">
			...
			<div class="team_field_right">
				<input type="button" class="button" value="<?php _e('Choose File', 'fractal'); ?>" onclick="add_employee_image(this)" />
				<br />
				<input class="button" type="button" value="<?php _e('Remove', 'fractal'); ?>" onclick="remove_employee_field(this)" />
			</div>
			<div class="team_clear"></div>
	...
	<div id="add_employee_row">
		<input class="button" type="button" value="<?php _e('Add Field', 'fractal'); ?>" onclick="add_employee_row();" />
	</div>
